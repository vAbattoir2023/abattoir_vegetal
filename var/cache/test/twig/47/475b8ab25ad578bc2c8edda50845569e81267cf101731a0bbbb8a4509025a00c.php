...
class __TwigTemplate_c3811434acaf62055ce1ed80fcbaa955b74d8e705f4ac19e9440d63f5d4ce574 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"info\">
        ...
        <div class=\"thirdData\">
            <p>";
            // line 21
            echo twig_escape_filter($this->env, twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "description", [], "any", false, false, false, 21), 0, 100), "html", null, true);
            echo "...</p>
        </div>
