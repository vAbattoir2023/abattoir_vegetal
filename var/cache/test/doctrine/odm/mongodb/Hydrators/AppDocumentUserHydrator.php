...
class AppDocumentUserHydrator implements HydratorInterface
{
    ...
    public function hydrate(object $document, array $data, array $hints = array()): array
    {
        ...
        /** @Field(type="string") */
        if (isset($data['codeDepartement']) || (! empty($this->class->fieldMappings['codeDepartement']['nullable']) && array_key_exists('codeDepartement', $data))) {
            $value = $data['codeDepartement'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['codeDepartement']['type'];
                $return = (string) $value;
            } else {
                $return = null;
            }
            $this->class->reflFields['codeDepartement']->setValue($document, $return);
            $hydratedData['codeDepartement'] = $return;
        }

        /** @Field(type="string") */
        if (isset($data['region']) || (! empty($this->class->fieldMappings['region']['nullable']) && array_key_exists('region', $data))) {
            $value = $data['region'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['region']['type'];
                $return = (string) $value;
            } else {
                $return = null;
            }
