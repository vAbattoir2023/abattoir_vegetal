...
return [
    ...
    'app_admin_index' => [[], ['_controller' => 'App\\Controller\\AdminGroupController::index'], [], [['text', '/admin/']], [], [], []],
    'app_admin_show' => [['id'], ['_controller' => 'App\\Controller\\AdminGroupController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin']], [], [], []],
    'app_admin_delete' => [['id'], ['_controller' => 'App\\Controller\\AdminGroupController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/delete']], [], [], []],
