...
class __TwigTemplate_d9a14a1f8821397f6863eb1b1dd38b940d7898f03d045b05c1fa3da928d72ce9 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "Admin/apiuser.html.twig", 1);
    ...
    <hr>
    <h4>Création de User en base de donnée</h4>

";
        // line 28
        echo " ";
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 28, $this->source); })()), "vars", [], "any", false, false, false, 28), "errors", [], "any", false, false, false, 28)) > 0)) {
            // line 29
            echo "        <div class=\"alert alert-danger\">
            ";
            // line 31
            echo "            ";
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 31, $this->source); })()), "postalCode", [], "any", false, false, false, 31), 'errors');
            echo "
        </div>
    ";
        }
...
";
    ...
    {
        return array (  138 => 39,  133 => 37,  129 => 36,  125 => 34,  118 => 31,  115 => 29,  112 => 28,  103 => 13,  99 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{# 
       <div  class=\"bg-light\">
                <div >{{ apiuser.job }}</div>
                 <div>{{ apiuser.postalCode }}</div>
                 <div >{{ apiuser.diet }}</div>
                {# <td>{{ user.allergy }}</td> 
                 <div >{{ apiuser.description }}</div> 
                <div >{{ apiuser.centerOfInterest|join(', ') }}</div>
       </div> #}
...
{% endblock %}", "Admin/apiuser.html.twig", "C:\\wamp64\\www\\projet\\php\\Nouveau dossier\\abattoir_vegetal\\templates\\Admin\\apiuser.html.twig");
    }
}
